...
typedef struct
{
	...
	uint8_t GPIO_PinPuPdControl;		/*Possible values from @TODO*/
	uint8_t GPIO_PinOPType;				/*Possible values from @TOOD*/
	uint8_t GPIO_PinAltFunMode;			/*Possible values from @TODO*/
}GPIO_PinConfig_t;
